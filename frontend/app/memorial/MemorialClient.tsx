...
export default function MemorialClient({ familyName }: { familyName: string }) {
  return (
    <Box sx={{ maxWidth: 700, mx: 'auto', py: { xs: 3, sm: 5 } }}>
      ...
      <Box className="card" sx={{ p: { xs: 3, sm: 5 }, mb: 4, textAlign: 'center' }}>
        <Typography sx={{ color: 'var(--text-secondary)', lineHeight: 1.8 }}>
          Browse and share photos from {familyName} family gatherings, events, and everyday moments.
        </Typography>
      </Box>
